...
probabilities <- c(participant1$probability[5:104], participant2$probability[5:104], participant3$probability[5:104],
                  participant4$probability[5:104], participant5$probability[5:104], participant6$probability[5:104],
                  participant7$probability[5:104], participant8$probability[5:104], participant9$probability[5:104],
                  participant10$probability[5:104], participant11$probability[5:104], participant12$probability[5:104],
                  participant13$probability[5:104], participant14$probability[5:104], participant15$probability[5:104],
                  participant16$probability[5:104], participant17$probability[5:104], participant18$probability[5:104],
                  participant19$probability[5:104], participant20$probability[5:104], participant21$probability[5:104],
                  participant22$probability[5:104], participant23$probability[5:104], participant24$probability[5:104])
responses <- c(participant1$response[5:104], participant2$response[5:104], participant3$response[5:104],
               participant4$response[5:104], participant5$response[5:104], participant6$response[5:104],
               participant7$response[5:104], participant8$response[5:104], participant9$response[5:104],
               participant10$response[5:104], participant11$response[5:104], participant12$response[5:104],
               participant13$response[5:104], participant14$response[5:104], participant15$response[5:104],
               participant16$response[5:104], participant17$response[5:104], participant18$response[5:104],
               participant19$response[5:104], participant20$response[5:104], participant21$response[5:104],
               participant22$response[5:104], participant23$response[5:104], participant24$response[5:104])
...
oneVowel_predictor_indices <- c(which(probabilities2 == OneVowel_Ps[1]),
                                which(probabilities2 == OneVowel_Ps[2]),
                                which(probabilities2 == OneVowel_Ps[3]),
                                which(probabilities2 == OneVowel_Ps[4]),
                                which(probabilities2 == OneVowel_Ps[5]),
                                which(probabilities2 == OneVowel_Ps[6]),
                                which(probabilities2 == OneVowel_Ps[7]),
                                which(probabilities2 == OneVowel_Ps[8]))

threeVowel_predictor_indices <- c(which(probabilities2 == EndThreeVowel_Ps[1]),
                                  which(probabilities2 == EndThreeVowel_Ps[2]),
                                  which(probabilities2 == EndThreeVowel_Ps[3]),
                                  which(probabilities2 == EndThreeVowel_Ps[4]),
                                  which(probabilities2 == EndThreeVowel_Ps[5]),
                                  which(probabilities2 == EndThreeVowel_Ps[6]),
                                  which(probabilities2 == EndThreeVowel_Ps[7]),
                                  which(probabilities2 == EndThreeVowel_Ps[8]),
                                  which(probabilities2 == EndThreeVowel_Ps[9]),
                                  which(probabilities2 == EndThreeVowel_Ps[10]),
                                  which(probabilities2 == EndThreeVowel_Ps[11]),
                                  which(probabilities2 == EndThreeVowel_Ps[12]),
                                  which(probabilities2 == EndThreeVowel_Ps[13]),
                                  which(probabilities2 == EndThreeVowel_Ps[14]),
                                  which(probabilities2 == EndThreeVowel_Ps[15]),
                                  which(probabilities2 == EndThreeVowel_Ps[16]),
                                  which(probabilities2 == EndThreeVowel_Ps[17]),
                                  which(probabilities2 == EndThreeVowel_Ps[18]),
                                  which(probabilities2 == EndThreeVowel_Ps[19]),
                                  which(probabilities2 == EndThreeVowel_Ps[20]),
                                  which(probabilities2 == EndThreeVowel_Ps[21]),
                                  which(probabilities2 == EndThreeVowel_Ps[22]),
                                  which(probabilities2 == EndThreeVowel_Ps[23]),
                                  which(probabilities2 == EndThreeVowel_Ps[24]),
                                  which(probabilities2 == EndThreeVowel_Ps[25]),
                                  which(probabilities2 == EndThreeVowel_Ps[26]),
                                  which(probabilities2 == EndThreeVowel_Ps[27]),
                                  which(probabilities2 == EndThreeVowel_Ps[28]),
                                  which(probabilities2 == EndThreeVowel_Ps[29]),
                                  which(probabilities2 == EndThreeVowel_Ps[30]),
                                  which(probabilities2 == EndThreeVowel_Ps[31]),
                                  which(probabilities2 == EndThreeVowel_Ps[32]),
                                  which(probabilities2 == EndThreeVowel_Ps[33]),
                                  which(probabilities2 == EndThreeVowel_Ps[34]),
                                  which(probabilities2 == EndThreeVowel_Ps[35]),
                                  which(probabilities2 == EndThreeVowel_Ps[36]),
                                  which(probabilities2 == EndThreeVowel_Ps[37]),
                                  which(probabilities2 == EndThreeVowel_Ps[38]),
                                  which(probabilities2 == EndThreeVowel_Ps[39]),
                                  which(probabilities2 == EndThreeVowel_Ps[40]),
                                  which(probabilities2 == EndThreeVowel_Ps[41]),
                                  which(probabilities2 == EndThreeVowel_Ps[42]),
                                  which(probabilities2 == EndThreeVowel_Ps[43]),
                                  which(probabilities2 == EndThreeVowel_Ps[44]),
                                  which(probabilities2 == EndThreeVowel_Ps[45]),
                                  which(probabilities2 == EndThreeVowel_Ps[46]),
                                  which(probabilities2 == EndThreeVowel_Ps[47]),
                                  which(probabilities2 == EndThreeVowel_Ps[48]),
                                  which(probabilities2 == EndThreeVowel_Ps[49]),
                                  which(probabilities2 == EndThreeVowel_Ps[50]),
                                  which(probabilities2 == SlantThreeVowel_Ps[1]),
                                  which(probabilities2 == SlantThreeVowel_Ps[2]),
                                  which(probabilities2 == SlantThreeVowel_Ps[3]),
                                  which(probabilities2 == SlantThreeVowel_Ps[4]),
                                  which(probabilities2 == SlantThreeVowel_Ps[5]),
                                  which(probabilities2 == SlantThreeVowel_Ps[6]),
                                  which(probabilities2 == SlantThreeVowel_Ps[7]),
                                  which(probabilities2 == SlantThreeVowel_Ps[8]),
                                  which(probabilities2 == SlantThreeVowel_Ps[9]),
                                  which(probabilities2 == SlantThreeVowel_Ps[10]),
                                  which(probabilities2 == SlantThreeVowel_Ps[11]),
                                  which(probabilities2 == SlantThreeVowel_Ps[12]),
                                  which(probabilities2 == SlantThreeVowel_Ps[13]),
                                  which(probabilities2 == SlantThreeVowel_Ps[14]),
                                  which(probabilities2 == SlantThreeVowel_Ps[15]),
                                  which(probabilities2 == SlantThreeVowel_Ps[16]),
                                  which(probabilities2 == SlantThreeVowel_Ps[17]),
                                  which(probabilities2 == SlantThreeVowel_Ps[18]),
                                  which(probabilities2 == SlantThreeVowel_Ps[19]),
                                  which(probabilities2 == SlantThreeVowel_Ps[20]),
                                  which(probabilities2 == SlantThreeVowel_Ps[21]),
                                  which(probabilities2 == SlantThreeVowel_Ps[22]),
                                  which(probabilities2 == SlantThreeVowel_Ps[23]),
                                  which(probabilities2 == SlantThreeVowel_Ps[24]),
                                  which(probabilities2 == SlantThreeVowel_Ps[25]),
                                  which(probabilities2 == SlantThreeVowel_Ps[26]),
                                  which(probabilities2 == SlantThreeVowel_Ps[27]),
                                  which(probabilities2 == SlantThreeVowel_Ps[28]),
                                  which(probabilities2 == SlantThreeVowel_Ps[29]),
                                  which(probabilities2 == SlantThreeVowel_Ps[30]),
                                  which(probabilities2 == SlantThreeVowel_Ps[31]),
                                  which(probabilities2 == SlantThreeVowel_Ps[32]),
                                  which(probabilities2 == SlantThreeVowel_Ps[33]),
                                  which(probabilities2 == SlantThreeVowel_Ps[34]),
                                  which(probabilities2 == SlantThreeVowel_Ps[35]),
                                  which(probabilities2 == SlantThreeVowel_Ps[36]),
                                  which(probabilities2 == SlantThreeVowel_Ps[37]),
                                  which(probabilities2 == SlantThreeVowel_Ps[38]),
                                  which(probabilities2 == SlantThreeVowel_Ps[39]),
                                  which(probabilities2 == SlantThreeVowel_Ps[40]),
                                  which(probabilities2 == SlantThreeVowel_Ps[41]),
                                  which(probabilities2 == SlantThreeVowel_Ps[42]),
                                  which(probabilities2 == SlantThreeVowel_Ps[43]),
                                  which(probabilities2 == SlantThreeVowel_Ps[44]),
                                  which(probabilities2 == SlantThreeVowel_Ps[45]),
                                  which(probabilities2 == SlantThreeVowel_Ps[46]),
                                  which(probabilities2 == SlantThreeVowel_Ps[47]),
                                  which(probabilities2 == SlantThreeVowel_Ps[48]),
                                  which(probabilities2 == SlantThreeVowel_Ps[49]),
                                  which(probabilities2 == SlantThreeVowel_Ps[50]),
                                  which(probabilities2 == InternalThreeVowel_Ps[1]),
                                  which(probabilities2 == InternalThreeVowel_Ps[2]),
                                  which(probabilities2 == InternalThreeVowel_Ps[3]),
                                  which(probabilities2 == InternalThreeVowel_Ps[4]),
                                  which(probabilities2 == InternalThreeVowel_Ps[5]),
                                  which(probabilities2 == InternalThreeVowel_Ps[6]),
                                  which(probabilities2 == InternalThreeVowel_Ps[7]),
                                  which(probabilities2 == InternalThreeVowel_Ps[8]),
                                  which(probabilities2 == InternalThreeVowel_Ps[9]),
                                  which(probabilities2 == InternalThreeVowel_Ps[10]),
                                  which(probabilities2 == InternalThreeVowel_Ps[11]),
                                  which(probabilities2 == InternalThreeVowel_Ps[12]),
                                  which(probabilities2 == InternalThreeVowel_Ps[13]),
                                  which(probabilities2 == InternalThreeVowel_Ps[14]),
                                  which(probabilities2 == InternalThreeVowel_Ps[15]),
                                  which(probabilities2 == InternalThreeVowel_Ps[16]),
                                  which(probabilities2 == InternalThreeVowel_Ps[17]),
                                  which(probabilities2 == InternalThreeVowel_Ps[18]),
                                  which(probabilities2 == InternalThreeVowel_Ps[19]),
                                  which(probabilities2 == InternalThreeVowel_Ps[20]),
                                  which(probabilities2 == InternalThreeVowel_Ps[21]),
                                  which(probabilities2 == InternalThreeVowel_Ps[22]),
                                  which(probabilities2 == InternalThreeVowel_Ps[23]),
                                  which(probabilities2 == InternalThreeVowel_Ps[24]),
                                  which(probabilities2 == InternalThreeVowel_Ps[25]),
                                  which(probabilities2 == InternalThreeVowel_Ps[26]),
                                  which(probabilities2 == InternalThreeVowel_Ps[27]),
                                  which(probabilities2 == InternalThreeVowel_Ps[28]),
                                  which(probabilities2 == InternalThreeVowel_Ps[29]),
                                  which(probabilities2 == InternalThreeVowel_Ps[30]),
                                  which(probabilities2 == InternalThreeVowel_Ps[31]),
                                  which(probabilities2 == InternalThreeVowel_Ps[32]),
                                  which(probabilities2 == InternalThreeVowel_Ps[33]),
                                  which(probabilities2 == InternalThreeVowel_Ps[34]),
                                  which(probabilities2 == InternalThreeVowel_Ps[35]),
                                  which(probabilities2 == InternalThreeVowel_Ps[36]),
                                  which(probabilities2 == InternalThreeVowel_Ps[37]),
                                  which(probabilities2 == InternalThreeVowel_Ps[38]),
                                  which(probabilities2 == InternalThreeVowel_Ps[39]),
                                  which(probabilities2 == InternalThreeVowel_Ps[40]),
                                  which(probabilities2 == InternalThreeVowel_Ps[41]),
                                  which(probabilities2 == InternalThreeVowel_Ps[42]),
                                  which(probabilities2 == InternalThreeVowel_Ps[43]),
                                  which(probabilities2 == InternalThreeVowel_Ps[44]),
                                  which(probabilities2 == InternalThreeVowel_Ps[45]),
                                  which(probabilities2 == InternalThreeVowel_Ps[46]),
                                  which(probabilities2 == InternalThreeVowel_Ps[47]),
                                  which(probabilities2 == InternalThreeVowel_Ps[48]),
                                  which(probabilities2 == InternalThreeVowel_Ps[49]),
                                  which(probabilities2 == InternalThreeVowel_Ps[50]))

two_vowel_predictor_indices <- c(which(probabilities2 == EndTwoVowel_Ps[1]),
                                 which(probabilities2 == EndTwoVowel_Ps[2]),
                                 which(probabilities2 == EndTwoVowel_Ps[3]),
                                 which(probabilities2 == EndTwoVowel_Ps[4]),
                                 which(probabilities2 == EndTwoVowel_Ps[5]),
                                 which(probabilities2 == EndTwoVowel_Ps[6]),
                                 which(probabilities2 == EndTwoVowel_Ps[7]),
                                 which(probabilities2 == EndTwoVowel_Ps[8]),
                                 which(probabilities2 == EndTwoVowel_Ps[9]),
                                 which(probabilities2 == EndTwoVowel_Ps[10]),
                                 which(probabilities2 == EndTwoVowel_Ps[11]),
                                 which(probabilities2 == EndTwoVowel_Ps[12]),
                                 which(probabilities2 == EndTwoVowel_Ps[13]),
                                 which(probabilities2 == EndTwoVowel_Ps[14]))
...
indices_0 <- which(df$log_probabilities == 0)
df_new <- df[-indices_0,]

responses3 <- responses2[-indices_0]
log_probabilities_2 <- log_probabilities[-indices_0]

model <- glmer(responses3~log_probabilities_2 + (1 | Vowels), data = df_new, family = binomial)
...
library(lmerTest)
lmm <- glmer(responses3 ~ logProbs + (1 | Vowels), family = binomial, data = df)
