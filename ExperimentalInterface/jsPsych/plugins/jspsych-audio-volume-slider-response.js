jsPsych.plugins['audio-volume-slider-response'] = (function() {
	var plugin = {};

	jsPsych.pluginAPI.registerPreload('audio-volume-slider-response', 'stimulus', 'audio');

	plugin.info = {
		name: 'audio-volume-slider-response',
		description: '',
    parameters: {
      stimulus: {
