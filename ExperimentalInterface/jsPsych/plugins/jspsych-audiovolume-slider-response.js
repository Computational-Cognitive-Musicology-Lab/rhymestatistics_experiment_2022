/**
 * jspsych-audiovolume-slider-response
...
jsPsych.plugins['audiovolume-slider-response'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'audiovolume-slider-response',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // My ADDED Stuff
    html += '<audio id="audioplayer" autoplay loop><source src="' + trial.stimulus + '" type="audio/wav">Your browser does not support the audio element.</audio>';
    ///
   ...
   document.getElementById('louder').addEventListener('click', function() {
     ...
     volumechanged = true;
     if (slidermoved) display_element.querySelector('#jspsych-html-slider-response-next').disabled = false;
