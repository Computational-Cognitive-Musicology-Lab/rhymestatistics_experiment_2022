    ...
    this.setTimelineVariablesOrder = function() {
      ...
      if(typeof timeline_parameters.sample !== 'undefined'){
        if(timeline_parameters.sample.type == 'custom'){
          ...
          order = jsPsych.randomization.shuffleAlternateGroups(timeline_parameters.sample.groups, timeline_parameters.sample.randomize_group_order, timeline_parameters.sample.size);
        } else {
...
jsPsych.randomization = (function() {
  ...
  module.shuffleAlternateGroups = function(arr_groups, random_group_order, size_per_group){
    ...
    var size = Math.min(min_length, size_per_group);
